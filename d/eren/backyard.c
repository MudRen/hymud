...
LONG
        ...
        set("item_desc", ([
                ...
                "door": "门关着，不知是否你可以打开(open)。\n",
                "门": "门关着，不知是否你可以打开(open)。\n",
        ]) );
...
string *event1_msg=     ({
        ...
        MAG"“不妨，小哈已经把他们支走。“\n"NOR,
        CYN"“嘿嘿，哈哈儿真有一手，几句好话就把人打发到千里之外。“\n"NOR,
        MAG"“没错，就算他们回来，沙漠里，哈哈，哈哈。。。。。“\n"NOR,
        CYN"“后院的那个如何处置？“\n"NOR,
        MAG"“杀，此事关系重大，不能留活口。“\n"NOR,
