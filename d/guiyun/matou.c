...
//tell_object(ob , "战船在一阵阵喊杀声中撞上了另一艘"+guanname+"。\n" ) ;
	...
	ob->set_name(me->query("name")+HIR" 贪官"NOR, ({ me->query("id")+" guan"}));
