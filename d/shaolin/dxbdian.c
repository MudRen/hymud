...
LONG );
	set("exits", ([
		...
		"north" : "/d/jinyong/book8/shaolin/zhengdian",
	]));
	set("valid_startroom",1);
	set("book_count",1);
	set("roomif","$botten#武僧任务|救援任务|救援取消|武僧取消:ask daozheng about wsjob|ask daozheng about job|ask daozheng about fail|ask daozheng about wsfail$#");
	set("objects",([
...
{
  	if(((int)me->query("jinyong/book8")!=7)&&(dir == "north"))
	{
		return notify_fail("守寺僧兵拦住了你：方丈有令，任何人不得进入正殿。\n");
	}
