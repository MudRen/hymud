...
//              "east": __DIR__"andao1",
        ...
        set("item_desc", ([
                "woman": "她浑身赤裸，只有一条轻纱。迷朦的轻纱环飞在她的腿臂左右，并没有掩遮她应遮
掩的地方。\n",
                "天魔女": "她浑身赤裸，只有一条轻纱。迷朦的轻纱环飞在她的腿臂左右，并没有掩遮她应遮
掩的地方。\n",
                "女人": "她浑身赤裸，只有一条轻纱。迷朦的轻纱环飞在她的腿臂左右，并没有掩遮她应遮
掩的地方。\n",
         ]));
        set("coor/x",0);
        set("coor/y",0);
...
int do_push(string arg)
{
        ...
        message_vision(WHT"天魔女诱人的笑容仿佛抹上了一层奇异的痛苦。她的两条脚倏地向后弯曲。这一弯，
