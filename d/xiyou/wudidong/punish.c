...
void init()
{
    ...
    if(me->query("startroom")!="/d/xiyou/wudidong/punish")
	me->set("startroom_old", me->query("startroom"));
    me->set("startroom", "/d/xiyou/wudidong/punish");
...
int do_search(string arg)
{
    ...
    if (me->query("qi")*100/me->query("max_qi")< 30
     || me->query("jing")*100/me->query("max_jing")< 30)
