...
int do_sell(string arg)
{
  ...
  baoziexp=ob->query("combat_exp")+ob->query("combat_exp");// baoziexp  «±ª¬Ù’ﬂµƒ«ø∂»°£
...
int check_ratio(object me, object ob)
{
    ...
    baoziexp=(ob->query("combat_exp")+ob->query("combat_exp"))/2;// baoziexp  «±ª¬Ù’ﬂµƒ«ø∂»°£
    myexp=me->query("combat_exp")+me->query("combat_exp");// myexp  «¬Ù’ﬂµƒ«ø∂»°£
...
int do_tellme(string arg)
{
    ...
    msg=GRN+seller->query("name")+"£®æ≠—È£∫"+(seller->query("combat_exp")+seller->query("combat_exp"))+"£©£¨";
    msg+="¬Ù"+baozi->query("name")+"£®æ≠—È£∫"+(baozi->query("combat_exp")+baozi->query("combat_exp"))+"£©°£\n";
