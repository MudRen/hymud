...
void create()
{
	      set_name("[1;31m×·»ê¶áÆÇ[2;37;0m", ({ "shengxie hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0mÕâÊÇÒ»¸±ÓÉÎŞ±È¼áÓ²µÄ[1;36mÍòÄêº®±ùÌú[2;37;0m¼ÓÉÏ[1;33mÁú¼ë²ÏË¿[2;37;0mÖÆ³É£¬ÖØÁù½ïÎåÁ½ÁãÇ®µÄ[31mÊ¤Ğ°Ö®ÊÖÌ×[2;37;0m¡£
