...
void create()
{
	      set_name("[1;33mÉñÖ®ÊÖÌ×[2;37;0m", ({ "yuchang hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0mÕâÊÇÒ»¸±ÓÉÎŞ±È¼áÓ²µÄ[1;36mÍòÄêº®±ùÌú[2;37;0m¼ÓÉÏ[1;33mÁú¼ë²ÏË¿[2;37;0mÖÆ³É£¬ÖØ¶ş½ïÁùÁ½ÈıÇ®µÄ[31mÓã³¦Ö®ÊÖÌ×[2;37;0m¡£
