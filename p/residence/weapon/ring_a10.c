...
void create()
{
	      set_name("[1;37mÒ¹ÔÂÇå»Ô[2;37;0m", ({ "gongbu hands", "hands" }));
        set_weight(1000);
        if( clonep() )
		...
		set("long", @LONG
[31m¹¤²¼ÌìÉú¹ÖÒì£¬¹¦ÄÜ²ÎÉÌ£¡
[2;37;0mÕâÊÇÒ»¸±ÓÉ¼«Æä¼áÓ²µÄ[1;36mÍòÄêº®±ùÌú[2;37;0m¼ÓÉÏ[1;33mÁú¼ë²ÏË¿[2;37;0mÖÆ³É£¬ÖØÎå½ïËÄÁ½ÆßÇ®µÄ[31m¹¤²¼Ö®ÊÖÌ×[2;37;0m¡£
...
°×Ê¯:[33mºÜ¸ß[2;37;0m ÍşÁ¦:[33mºÜ¸ß[2;37;0m 
