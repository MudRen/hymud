...
void create()
{
	set_name("[1;33m¼¯ÏÉÖ®´¸[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(7820);
	if (clonep())
		...
		set("unit", "±ú");
		set("long", @LONG
¼¯ÏÉÖ®´¸[2;37;0mÕâÊÇÒ»±úÓÉÎŞ±È¼áÓ²µÄ[33mÉúÌú[2;37;0mÖÆ³É£¬ÖØÊ®Îå½ïÁùÁ½ËÄÇ®µÄ[1;33m¼¯ÏÉÖ®´¸[2;37;0m¡£
...
ÌìĞş:[33mÒ»°ã[2;37;0m ÌåÁé:[36m²»´í[2;37;0m °×Ê¯:[36m²»´í[2;37;0m ×ÏÊ¯:[33mÒ»°ã[2;37;0m ²»ÀÏ:[36m²»´í[2;37;0m 
