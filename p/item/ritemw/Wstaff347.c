...
void create()
{
	set_name("[36mÍõÕßÖ®ÕÈ[2;37;0m", ({ "wangzhe staff", "staff" }));
	set_weight(12300);
	if (clonep())
		...
		set("unit", "¸ù");
		set("long", @LONG
[36mÍõÕßÖ®ÕÈ[2;37;0mÕâÊÇÒ»¸ùÓÉÎŞ±È¼áÓ²µÄ[1;32mÂÌÊ¯[2;37;0mÖÆ³É£¬ÖØ¶şÊ®ËÄ½ïÁùÁ½ÁãÇ®µÄ[36mÍõÕßÖ®ÕÈ[2;37;0m¡£
...
¾ø´ú:[34mÏ¸Ëé[2;37;0m ÌìÔ¨:[34mÏ¸Ëé[2;37;0m ÖÜÌì:[36m²»´í[2;37;0m 
