...
void create()
{
	set_name("[35m³àÏ¼Ö®¹÷[2;37;0m", ({ "general club", "club" }));
	set_weight(4095);
	if (clonep())
		...
		set("unit", "¸ù");
		set("long", @LONG
³àÏ¼Ö®¹÷[2;37;0mÕâÊÇÒ»¸ùÓÉÎŞ±È¼áÓ²µÄ[33mÉúÌú[2;37;0mÖÆ³É£¬ÖØ°Ë½ïÒ»Á½¾ÅÇ®µÄ[35m³àÏ¼Ö®¹÷[2;37;0m¡£
...
°×Ê¯:[36m²»´í[2;37;0m ÍşÁ¦:[33mÒ»°ã[2;37;0m 
