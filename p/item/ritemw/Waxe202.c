...
void create()
{
	set_name("[1;36mÜ½ÈØÖ®¸«[2;37;0m", ({ "good axe", "axe" }));
	set_weight(5100);
	if (clonep())
		...
		set("unit", "±ú");
		set("long", @LONG
Ü½ÈØÖ®¸«[2;37;0mÕâÊÇÒ»±úÓÉÎŞ±È¼áÓ²µÄ[33mÈíÌú[2;37;0mÖÆ³É£¬ÖØÊ®½ï¶şÁ½ÁãÇ®µÄ[1;36mÜ½ÈØÖ®¸«[2;37;0m¡£
×ÛºÏÆÀ¼Û[1;34m¾ÙÊÀº±¼û[2;37;0m ¿´ÆğÀ´ÎŞ±È·æÀû£¬¾ßÓĞ[35m¼«Æä¿ÉÅÂ[2;37;0mµÄÍşÁ¦£¡
ÉÏÃæ¿ÌÁË¼¸¸ö¹Å·ûºÅ£º
[1;33m½ğ[2;37;0m:[1;34m¾ÙÊÀ[2;37;0m [40mµØ[2;37;0m:[1;32mÄ§Íõ[2;37;0m 
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
