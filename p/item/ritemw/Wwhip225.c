...
void create()
{
	set_name("[36m»êÆÇÖ®±Ş[2;37;0m", ({ "good whip", "whip" }));
	set_weight(4823);
	if (clonep())
		...
		set("unit", "¸ù");
		set("long", @LONG
»êÆÇÖ®±Ş[2;37;0mÕâÊÇÒ»¸ùÓÉ¼«Æä¼áÓ²µÄ[33mÈíÌú[2;37;0mÖÆ³É£¬ÖØ¾Å½ïÁùÁ½ËÄÇ®µÄ[36m»êÆÇÖ®±Ş[2;37;0m¡£
...
ÌåÁé:[34mÏ¸Ëé[2;37;0m ³¤Éú:[34mÏ¸Ëé[2;37;0m ²»ÀÏ:[32m´Ö²Ú[2;37;0m 
