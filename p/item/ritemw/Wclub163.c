...
void create()
{
	set_name("[34m¶Å¾éÖ®¹÷[2;37;0m", ({ "general club", "club" }));
	set_weight(3430);
	if (clonep())
		...
		set("unit", "¸ù");
		set("long", @LONG
¶Å¾éÖ®¹÷[2;37;0mÕâÊÇÒ»¸ùÓÉÏàµ±¼áÓ²µÄ[33mÉúÌú[2;37;0mÖÆ³É£¬ÖØÁù½ï°ËÁ½ÁùÇ®µÄ[34m¶Å¾éÖ®¹÷[2;37;0m¡£
...
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[31m¾«ÖÂ[2;37;0m ÌìÔ¨:[36m²»´í[2;37;0m ²»ÀÏ:[33mÒ»°ã[2;37;0m 
