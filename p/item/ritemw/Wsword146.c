...
void create()
{
	set_name("[31m°×úQÖ®½£[2;37;0m", ({ "general sword", "sword" }));
	set_weight(13553);
	if (clonep())
		...
		set("unit", "°Ñ");
		set("long", @LONG
°×úQÖ®½£[2;37;0mÕâÊÇÒ»°ÑÓÉÎŞ±È¼áÓ²µÄ[33mÉúÌú[2;37;0mÖÆ³É£¬ÖØ¶şÊ®Æß½ïÒ»Á½ÁãÇ®µÄ[31m°×úQÖ®½£[2;37;0m¡£
...
ÌåÁé:[32m¼«²î[2;37;0m °×Ê¯:[36m²»´í[2;37;0m ³¤Éú:[34mÏ¸Ëé[2;37;0m 
