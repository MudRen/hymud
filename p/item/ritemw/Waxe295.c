...
void create()
{
	set_name("[1;33mÒ¹ÔÆÖ®¸«[2;37;0m", ({ "good axe", "axe" }));
	set_weight(3733);
	if (clonep())
		...
		set("unit", "±ú");
		set("long", @LONG
Ò¹ÔÆÖ®¸«[2;37;0mÕâÊÇÒ»±úÓÉÎŞ±È¼áÓ²µÄ[33mÈíÌú[2;37;0mÖÆ³É£¬ÖØÆß½ïËÄÁ½ÁùÇ®µÄ[1;33mÒ¹ÔÆÖ®¸«[2;37;0m¡£
...
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[1;31m¿ªÔª[2;37;0m ÌìĞş:[36m²»´í[2;37;0m °×Ê¯:[34mÏ¸Ëé[2;37;0m ÖÜÌì:[34mÏ¸Ëé[2;37;0m 
