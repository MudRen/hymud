...
void create()
{
	set_name("[1;32mÇÉÖ®½£[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(12833);
	if (clonep())
		...
		set("unit", "°Ñ");
		set("long", @LONG
ÇÉÖ®½£[2;37;0mÕâÊÇÒ»°ÑÓÉÊ®·Ö¼áÓ²µÄ[32mÇàÍ­[2;37;0mÖÆ³É£¬ÖØ¶şÊ®Îå½ïÁùÁ½ÁùÇ®µÄ[1;32mÇÉÖ®½£[2;37;0m¡£
...
ÌìĞş:[33mÒ»°ã[2;37;0m ×ÏÊ¯:[33mÒ»°ã[2;37;0m ÉÁµç:[32m¼«²î[2;37;0m 
²»ÀÏ:[32m¼«²î[2;37;0m 
