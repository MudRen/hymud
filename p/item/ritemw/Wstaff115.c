...
void create()
{
	set_name("[36m¾ÛÈªÖ®ÕÈ[2;37;0m", ({ "general staff", "staff" }));
	set_weight(1692);
	if (clonep())
		...
		set("unit", "¸ù");
		set("long", @LONG
¾ÛÈªÖ®ÕÈ[2;37;0mÕâÊÇÒ»¸ùÓÉÎŞ±È¼áÓ²µÄ[33mÉúÌú[2;37;0mÖÆ³É£¬ÖØÈı½ïÈıÁ½°ËÇ®µÄ[36m¾ÛÈªÖ®ÕÈ[2;37;0m¡£
×ÛºÏÆÀ¼Û[31mÍêÃÀ¾«ÖÂ[2;37;0m ¿´ÆğÀ´ÎŞ±È·æÀû£¬¾ßÓĞ[32mË®×¼ÒÔÉÏ[2;37;0mµÄÍşÁ¦£¡
ÉÏÃæ¿ÌÁË¼¸¸ö¹Å·ûºÅ£º
[1;35m·ç[2;37;0m:[35m±ê×¼[2;37;0m 

ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[31m¾«ÖÂ[2;37;0m ¾ø´ú:[33mÒ»°ã[2;37;0m ÇÉÖÆ:[32m¼«²î[2;37;0m 
