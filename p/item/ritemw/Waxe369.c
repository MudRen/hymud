...
void create()
{
	set_name("[1;32mÆÆ¼×Ö®¸«[2;37;0m", ({ "pojia axe", "axe" }));
	set_weight(10731);
	if (clonep())
		...
		set("unit", "±ú");
		set("long", @LONG
[1;32mÆÆ¼×Ö®¸«[2;37;0mÕâÊÇÒ»±úÓÉÎŞ±È¼áÓ²µÄ[1;32mÂÌÊ¯[2;37;0mÖÆ³É£¬ÖØ¶şÊ®Ò»½ïËÄÁ½ÁùÇ®µÄ[1;32mÆÆ¼×Ö®¸«[2;37;0m¡£
...
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[1;31m»ÙÌì[2;37;0m °×Ê¯:[34mÏ¸Ëé[2;37;0m ÉÁµç:[33mºÜ¸ß[2;37;0m 
²»ÀÏ:[32m´Ö²Ú[2;37;0m 
