...
void create()
{
	      set_name("[1;32mÔÂÁúÖ®Í·¿ø[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¶¥");
		set("long", @LONG
ÔÂÁúÖ®Í·¿ø[2;37;0mÕâÊÇÒ»¶¥ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[33mÑÇÂé[2;37;0mÖÆ³É£¬ÖØÁã½ïÆßÁ½ÁùÇ®µÄ[1;32mÔÂÁúÖ®Í·¿ø[2;37;0m¡£
