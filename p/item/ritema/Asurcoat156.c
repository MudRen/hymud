...
void create()
{
	      set_name("[1;37mºÚ÷ÈÖ®¶Ç´ø[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ìõ");
		set("long", @LONG
ºÚ÷ÈÖ®¶Ç´ø[2;37;0mÕâÊÇÒ»ÌõÓÉ¾ø¶Ô¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[33mÑÇÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï¾ÅÁ½ÈıÇ®µÄ[1;37mºÚ÷ÈÖ®¶Ç´ø[2;37;0m¡£
