...
void create()
{
	      set_name("[32mÁúÏèÖ®¶Ç´ø[2;37;0m", ({ "longxiang surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ìõ");
		set("long", @LONG
[32mÁúÏèÖ®¶Ç´ø[2;37;0mÕâÊÇÒ»ÌõÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÒ»Á½ÈıÇ®µÄ[32mÁúÏèÖ®¶Ç´ø[2;37;0m¡£
