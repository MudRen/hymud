...
void create()
{
	      set_name("[36m×ÏºçÖ®Åû·ç[2;37;0m", ({ "zihong armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼þ");
		set("long", @LONG
[36m×ÏºçÖ®Åû·ç[2;37;0mÕâÊÇÒ»¼þÓÉÎÞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÁãÁ½ÁãÇ®µÄ[36m×ÏºçÖ®Åû·ç[2;37;0m¡£
