...
void create()
{
	      set_name("[1;32m¿ñÀÇÖ®Åû·ç[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼ş");
		set("long", @LONG
¿ñÀÇÖ®Åû·ç[2;37;0mÕâÊÇÒ»¼şÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[33m´óÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ÆßÇ®µÄ[1;32m¿ñÀÇÖ®Åû·ç[2;37;0m¡£
