...
void create()
{
	      set_name("[1;31m±ÙÐ°Ö®Åû·ç[2;37;0m", ({ "pixie armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼þ");
		set("long", @LONG
[1;31m±ÙÐ°Ö®Åû·ç[2;37;0mÕâÊÇÒ»¼þÓÉÎÞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÈýÁ½ÆßÇ®µÄ[1;31m±ÙÐ°Ö®Åû·ç[2;37;0m¡£
