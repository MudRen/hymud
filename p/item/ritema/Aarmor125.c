...
void create()
{
	      set_name("[1;33mĞı·çÖ®Åû·ç[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼ş");
		set("long", @LONG
Ğı·çÖ®Åû·ç[2;37;0mÕâÊÇÒ»¼şÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[33mÑÇÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÒ»Á½¶şÇ®µÄ[1;33mĞı·çÖ®Åû·ç[2;37;0m¡£
