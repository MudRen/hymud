...
void create()
{
	      set_name("[35m·ï»ËÖ®»¤Íó[2;37;0m", ({ "fenghuang wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ë«");
		set("long", @LONG
[35m·ï»ËÖ®»¤Íó[2;37;0mÕâÊÇÒ»Ë«ÓÉÎÞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ïÆßÁ½ÁãÇ®µÄ[35m·ï»ËÖ®»¤Íó[2;37;0m¡£
