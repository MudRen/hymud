...
void create()
{
	      set_name("[1;31mÕªĞÇÖ®ÏîÁ´[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "´®");
		set("long", @LONG
ÕªĞÇÖ®ÏîÁ´[2;37;0mÕâÊÇÒ»´®ÓÉ¼«Îª¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[33mÑÇÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïËÄÁ½°ËÇ®µÄ[1;31mÕªĞÇÖ®ÏîÁ´[2;37;0m¡£
...
×ÏÊ¯:[34mÏ¸Ëé[2;37;0m ÖÜÌì:[32m¼«²î[2;37;0m 
