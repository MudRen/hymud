...
void create()
{
	      set_name("[1;34m¿ñÁúÖ®Åû·ç[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼ş");
		set("long", @LONG
¿ñÁúÖ®Åû·ç[2;37;0mÕâÊÇÒ»¼şÓÉ·Ç³£¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[33m´óÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ÁùÇ®µÄ[1;34m¿ñÁúÖ®Åû·ç[2;37;0m¡£
