...
void create()
{
	      set_name("[1;32mÎäÒíÖ®Í·¿ø[2;37;0m", ({ "wuyi head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¶¥");
		set("long", @LONG
[1;32mÎäÒíÖ®Í·¿ø[2;37;0mÕâÊÇÒ»¶¥ÓÉ¼«Æä¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÁãÁ½ÎåÇ®µÄ[1;32mÎäÒíÖ®Í·¿ø[2;37;0m¡£
