...
void create()
{
	      set_name("[37mÉúËÀÖ®ÏîÁ´[2;37;0m", ({ "shengsi neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "´®");
		set("long", @LONG
[37mÉúËÀÖ®ÏîÁ´[2;37;0mÕâÊÇÒ»´®ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÎåÁ½ÈıÇ®µÄ[37mÉúËÀÖ®ÏîÁ´[2;37;0m¡£
