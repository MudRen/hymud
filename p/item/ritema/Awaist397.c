...
void create()
{
	      set_name("[37mÌ«·çÖ®Ñü´ø[2;37;0m", ({ "taifeng waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ìõ");
		set("long", @LONG
[37mÌ«·çÖ®Ñü´ø[2;37;0mÕâÊÇÒ»ÌõÓÉÎÞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½¾ÅÇ®µÄ[37mÌ«·çÖ®Ñü´ø[2;37;0m¡£
