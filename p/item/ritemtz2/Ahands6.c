...
void create()
{
	      set_name("[1;35m·çÔÆÖ®ÊÖÌ×[2;37;0m¡ï", ({ "fengyun hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0mÕâÊÇÒ»¸±ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;37m²ÏË¿[2;37;0mÖÆ³É£¬ÖØÁã½ïÁùÁ½ÆßÇ®µÄ[1;35m·çÔÆÖ®ÊÖÌ×[2;37;0m¡£
...
ÖÜÌì:[35m±ê×¼[2;37;0m ³¤Éú:[34mÏ¸Ëé[2;37;0m ÍşÁ¦:[35m±ê×¼[2;37;0m 
