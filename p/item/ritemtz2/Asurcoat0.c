...
void create()
{
	      set_name("[1;34mÇÇÒÀÎÚË¹Ö®¶Ç´ø[2;37;0m¡ï", ({ "joeywus surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0mÕâÊÇÒ»ÌõÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;37m²ÏË¿[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ËÄÇ®µÄ[1;34mÇÇÒÀÎÚË¹Ö®¶Ç´ø[2;37;0m¡£
