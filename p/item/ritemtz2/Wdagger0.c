...
void create()
{
	set_name("[1;34mÇÇÒÀÎÚË¹Ö®Ø°Ê×[2;37;0m¡ï", ({ "joeywus dagger", "dagger" }));
	set_weight(13613);
	if (clonep())
...
[2;37;0mÕâÊÇÒ»°ÑÓÉÎŞ±È¼áÓ²µÄ[31mÁ÷»¨Ê¯[2;37;0mÖÆ³É£¬ÖØ¶şÊ®Æß½ï¶şÁ½¶şÇ®µÄ[1;34mÇÇÒÀÎÚË¹Ö®Ø°Ê×[2;37;0m¡£
