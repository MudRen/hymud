...
void create()
{
	      set_name("[1;34mÇÇÒÀÎÚË¹Ö®»¤Íó[2;37;0m¡ï", ({ "joeywus wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0mÕâÊÇÒ»Ë«ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;37m²ÏË¿[2;37;0mÖÆ³É£¬ÖØÒ»½ïÎåÁ½¶şÇ®µÄ[1;34mÇÇÒÀÎÚË¹Ö®»¤Íó[2;37;0m¡£
