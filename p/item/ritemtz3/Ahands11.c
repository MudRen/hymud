...
void create()
{
	      set_name("[35mÈıÁúÖ®ÊÖÌ×[2;37;0m¡ï", ({ "sanlong hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¸±");
		set("long", @LONG
[35mÈıÁúÖ®ÊÖÌ×[2;37;0mÕâÊÇÒ»¸±ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ïÆßÁ½¾ÅÇ®µÄ[35mÈıÁúÖ®ÊÖÌ×[2;37;0m¡£
