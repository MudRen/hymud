...
void create()
{
	      set_name("[35mÌìçáÖ®Ñü´ø[2;37;0m¡ï", ({ "tianji waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ìõ");
		set("long", @LONG
[35mÌìçáÖ®Ñü´ø[2;37;0mÕâÊÇÒ»ÌõÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ïÆßÁ½ÁãÇ®µÄ[35mÌìçáÖ®Ñü´ø[2;37;0m¡£
