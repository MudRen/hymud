...
void create()
{
	set_name("[35mÎåÁúÖ®µ¶[2;37;0m¡ï", ({ "wulong blade", "blade" }));
	set_weight(9049);
	if (clonep())
		...
		set("unit", "±ú");
		set("long", @LONG
[35mÎåÁúÖ®µ¶[2;37;0mÕâÊÇÒ»±úÓÉÎŞ±È¼áÓ²µÄ[1;32mÂÌÊ¯[2;37;0mÖÆ³É£¬ÖØÊ®°Ë½ïÁãÁ½¾ÅÇ®µÄ[35mÎåÁúÖ®µ¶[2;37;0m¡£
×ÛºÏÆÀ¼Û[37m¾øÊÀÎŞË«[2;37;0m ¿´ÆğÀ´ÎŞ±È·æÀû£¬¾ßÓĞ[1;33m¾ÙÊÀÎŞÆ¥[2;37;0mµÄÍşÁ¦£¡
ÉÏÃæ¿ÌÁË¼¸¸ö¹Å·ûºÅ£º
[1;31mÄ§[2;37;0m:[35m±ê×¼[2;37;0m 
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[1;31m´´ÊÀ[2;37;0m ÇÉÖÆ:[36m²»´í[2;37;0m 
