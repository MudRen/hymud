...
void create()
{
	set_name("[33m»ÆÁúÖ®¸«[2;37;0m¡ï", ({ "huanglong axe", "axe" }));
	set_weight(8508);
	if (clonep())
		...
		set("unit", "±ú");
		set("long", @LONG
[33m»ÆÁúÖ®¸«[2;37;0mÕâÊÇÒ»±úÓÉÎŞ±È¼áÓ²µÄ[1;32mÂÌÊ¯[2;37;0mÖÆ³É£¬ÖØÊ®Æß½ïÁãÁ½Ò»Ç®µÄ[33m»ÆÁúÖ®¸«[2;37;0m¡£
...
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[1;31m¿ªÔª[2;37;0m ÌìĞş:[34mÏ¸Ëé[2;37;0m ×ÏÊ¯:[32m´Ö²Ú[2;37;0m ²»ÀÏ:[33mºÜ¸ß[2;37;0m 
