...
void create()
{
	      set_name("[36mÉñÍõÖ®Åû·ç[2;37;0m¡ï", ({ "shenwang armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼ş");
		set("long", @LONG
[36mÉñÍõÖ®Åû·ç[2;37;0mÕâÊÇÒ»¼şÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ÁùÇ®µÄ[36mÉñÍõÖ®Åû·ç[2;37;0m¡£
