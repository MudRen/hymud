...
void create()
{
	      set_name("[35mÒ¡¹âÖ®ÊÖÌ×[2;37;0m¡ï", ({ "yaoguang hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¸±");
		set("long", @LONG
[35mÒ¡¹âÖ®ÊÖÌ×[2;37;0mÕâÊÇÒ»¸±ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÈıÁ½ÎåÇ®µÄ[35mÒ¡¹âÖ®ÊÖÌ×[2;37;0m¡£
