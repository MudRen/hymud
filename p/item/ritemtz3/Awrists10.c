...
void create()
{
	      set_name("[35mÎåÁúÖ®»¤Íó[2;37;0m¡ï", ({ "wulong wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ë«");
		set("long", @LONG
[35mÎåÁúÖ®»¤Íó[2;37;0mÕâÊÇÒ»Ë«ÓÉ¼«Îª¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ïÆßÁ½¾ÅÇ®µÄ[35mÎåÁúÖ®»¤Íó[2;37;0m¡£
