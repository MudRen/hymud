...
void create()
{
	      set_name("[32mÁúÏèÖ®»¤Íó[2;37;0m¡ï", ({ "longxiang wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ë«");
		set("long", @LONG
[32mÁúÏèÖ®»¤Íó[2;37;0mÕâÊÇÒ»Ë«ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ïÁùÁ½Ò»Ç®µÄ[32mÁúÏèÖ®»¤Íó[2;37;0m¡£
