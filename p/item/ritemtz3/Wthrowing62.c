...
void create()
{
	set_name("[34m¹«ºîÖ®°µÆ÷[2;37;0m¡ï", ({ "gonghou throwing", "throwing" }));
	set_weight(429);
	if (clonep())
		...
		set("unit", "Ö§");
		set("long", @LONG
[34m¹«ºîÖ®°µÆ÷[2;37;0mÕâÊÇÒ»Ö§ÓÉÎŞ±È¼áÓ²µÄ[1;32mÂÌÊ¯[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ÎåÇ®µÄ[34m¹«ºîÖ®°µÆ÷[2;37;0m¡£
...
ÉÏÃæ»¹¿ÌÁËÒ»Ğ©·û×Ö£º
·æÀû:[1;33mÃğÊÀ[2;37;0m ÌìÓî:[34mÏ¸Ëé[2;37;0m ÌìĞş:[36m²»´í[2;37;0m ²»ÀÏ:[34mÏ¸Ëé[2;37;0m 
