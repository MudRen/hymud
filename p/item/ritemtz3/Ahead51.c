...
void create()
{
	      set_name("[1;32mÄñÏèÖ®Í·¿ø[2;37;0m¡ï", ({ "niaoxiang head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¶¥");
		set("long", @LONG
[1;32mÄñÏèÖ®Í·¿ø[2;37;0mÕâÊÇÒ»¶¥ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï¾ÅÁ½¶şÇ®µÄ[1;32mÄñÏèÖ®Í·¿ø[2;37;0m¡£
