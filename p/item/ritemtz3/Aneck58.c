...
void create()
{
	      set_name("[36mÄıËªÖ®ÏîÁ´[2;37;0m¡ï", ({ "ningshuang neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "´®");
		set("long", @LONG
[36mÄıËªÖ®ÏîÁ´[2;37;0mÕâÊÇÒ»´®ÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÒ»Á½°ËÇ®µÄ[36mÄıËªÖ®ÏîÁ´[2;37;0m¡£
...
ÌåÁé:[35m±ê×¼[2;37;0m ²»ÀÏ:[33mºÜ¸ß[2;37;0m ÍşÁ¦:[34mÏ¸Ëé[2;37;0m 
