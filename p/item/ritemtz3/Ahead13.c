...
void create()
{
	      set_name("[37mÉúËÀÖ®Í·¿ø[2;37;0m¡ï", ({ "shengsi head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¶¥");
		set("long", @LONG
[37mÉúËÀÖ®Í·¿ø[2;37;0mÕâÊÇÒ»¶¥ÓÉ¾ø¶Ô¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ÎåÇ®µÄ[37mÉúËÀÖ®Í·¿ø[2;37;0m¡£
