...
void create()
{
	      set_name("[35m¾ÅÁúÖ®¶Ü[2;37;0m¡ï", ({ "jiulong shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ãæ");
		set("long", @LONG
[35m¾ÅÁúÖ®¶Ü[2;37;0mÕâÊÇÒ»ÃæÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØ¶ş½ïËÄÁ½Ò»Ç®µÄ[35m¾ÅÁúÖ®¶Ü[2;37;0m¡£
