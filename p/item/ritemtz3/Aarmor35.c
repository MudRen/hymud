...
void create()
{
	      set_name("[1;32mÎÞÓ°Ö®Åû·ç[2;37;0m¡ï", ({ "wuying armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼þ");
		set("long", @LONG
[1;32mÎÞÓ°Ö®Åû·ç[2;37;0mÕâÊÇÒ»¼þÓÉÎÞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ï¶þÁ½¾ÅÇ®µÄ[1;32mÎÞÓ°Ö®Åû·ç[2;37;0m¡£
