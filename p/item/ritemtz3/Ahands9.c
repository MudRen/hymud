...
void create()
{
	      set_name("[35m¾ÅÁúÖ®ÊÖÌ×[2;37;0m¡ï", ({ "jiulong hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¸±");
		set("long", @LONG
[35m¾ÅÁúÖ®ÊÖÌ×[2;37;0mÕâÊÇÒ»¸±ÓÉ¼«Îª¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ïÈıÁ½Ò»Ç®µÄ[35m¾ÅÁúÖ®ÊÖÌ×[2;37;0m¡£
