...
void create()
{
	      set_name("[35m·ï»ËÖ®Åû·ç[2;37;0m¡ï", ({ "fenghuang armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¼ş");
		set("long", @LONG
[35m·ï»ËÖ®Åû·ç[2;37;0mÕâÊÇÒ»¼şÓÉÎŞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï¾ÅÁ½ÎåÇ®µÄ[35m·ï»ËÖ®Åû·ç[2;37;0m¡£
