...
void create()
{
	      set_name("[1;31m»ðÁúÖ®Í·¿ø[2;37;0m¡ï", ({ "huolong head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "¶¥");
		set("long", @LONG
[1;31m»ðÁúÖ®Í·¿ø[2;37;0mÕâÊÇÒ»¶¥ÓÉÎÞ±È¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÁã½ï°ËÁ½ÈýÇ®µÄ[1;31m»ðÁúÖ®Í·¿ø[2;37;0m¡£
