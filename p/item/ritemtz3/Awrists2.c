...
void create()
{
	      set_name("[1;34mĞşÎäÖ®»¤Íó[2;37;0m¡ï", ({ "xuanwu wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "Ë«");
		set("long", @LONG
[1;34mĞşÎäÖ®»¤Íó[2;37;0mÕâÊÇÒ»Ë«ÓÉ¼«Îª¼áÓ²µÄ¾«¸Ö¼ÓÉÏ[1;33mÜÑÂé[2;37;0mÖÆ³É£¬ÖØÒ»½ï¶şÁ½¾ÅÇ®µÄ[1;34mĞşÎäÖ®»¤Íó[2;37;0m¡£
