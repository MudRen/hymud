...
me->set_temp("singn",st1);
       if(!arg) return notify_fail("ÄãÏë³ªÊ²Ã´£¿\n");
        ...
        tell_object(me,"Äã¶Ô"+ob1->query("name")+"£¬µãÁËµãÍ·¡£\n");
...
tell_object(me,ob1->query("name")+"ÌıÁËºó£¬ĞÄ¿õÉñÒÆ¡£¶ÔÄãÎ¢Î¢Ò»Ğ¦!\n");
//tell_object(me,"ÄãµÄ¾­Ñé¼ÓÁË"+chinese_number(12+b1)+"µã¡£\n");
//tell_object(me,"ÄãµÄÇ±ÄÜ¼ÓÁË"+chinese_number(8+b2)+"µã¡£\n");
